...
/** Implements multiset-mode forward subsumption-oriented 
 *  subsumption tests on lists of literals (without indexing). 
 */
public class ForwardSubsumption {

    public ForwardSubsumption(Collection<? extends FlattermLiteral> clause) {
	...
	ForwardSubsumption attempt = new ForwardSubsumption(clause2);
