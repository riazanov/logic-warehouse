 ...
 * of backtracking; these substitutions affect instance3() values in 
 * variables. See also {@link logic.is.power.logic_warehouse.Substitution1} and 
 * {@link logic.is.power.logic_warehouse.Substitution2} that affect
 * instance1() and instance2() correspondingly.
 */
public class Substitution3 {

    public Substitution3() {
	...
	{
	    --_stackSize;
	    _instantiatedVariables.get(_stackSize).uninstantiate3();
    ...
    /** Calls <code>var.instantiate3(instance)</code> and registers this 
     *  variable assignment.
     *  <b>pre:</b> <code>!var.isInstantiated3()</code>
     *  <b>post:</b> <code>var.isInstantiated3()</code>
     */
    public final void instantiate(Variable var,Term instance) {
	assert !var.isInstantiated3();
	var.instantiate3(instance);
	...
	for (int n = 0; n < _stackSize; ++n)
	{
		...
		" <- " +
		_instantiatedVariables.get(n).instance3();
	    if (n + 1 < _stackSize)
		result += ", ";
	};
	return result;
