 ...
 * of backtracking; these substitutions affect instance2() values in 
 ...
 * instance1() and instance3() correspondingly.
 */
public class Substitution2 {

    public Substitution2() {
	...
	{
	    --_stackSize;
	    _instantiatedVariables.get(_stackSize).uninstantiate2();
    ...
    /** Calls <code>var.instantiate2(instance)</code> and registers this 
     *  variable assignment.
     *  <b>pre:</b> <code>!var.isInstantiated2()</code>
     *  <b>post:</b> <code>var.isInstantiated2()</code>
     */
    public final void instantiate(Variable var,Flatterm instance) {
	assert !var.isInstantiated2();
	var.instantiate2(instance);
	...
	for (int n = 0; n < _stackSize; ++n)
	{
		...
		" <- " +
		_instantiatedVariables.get(n).instance2();
	    if (n + 1 < _stackSize)
		result += ", ";
	};
	return result;
